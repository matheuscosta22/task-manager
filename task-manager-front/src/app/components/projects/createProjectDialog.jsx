...
export default function CreateProjectDialog({ handleClose, openCreateDialog }) {
    const {
        control,
        register,
        handleSubmit,
    ...
    const onSubmit = async (data) => {
        const response = await CreateProject(
            data.title, data.description, data.status, data.due_date, data.responsible_id, data.priority
        );
