...
export default function CreateTaskDialog({ handleClose, openCreateDialog }) {
    const {
        control,
        register,
        handleSubmit,
    ...
    const onSubmit = async (data) => {
        const response = await CreateTask(
            data.title, data.description, data.status, data.due_date, data.responsible_id, data.priority, data.project_id
        );
